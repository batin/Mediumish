...
//mail.addEventListener("keypress", val)

function mailInputCount() {
...
mail.keyup(function(){
  let atKey = mailInputCount().includes("@")
  let key = mailInputCount().length
